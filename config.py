...
ORDER_DATA_QUESTION_ID = int(os.getenv("ORDER_DATA_QUESTION_ID", "6250"))
VENDOR_DATA_QUESTION_ID = int(os.getenv("VENDOR_DATA_QUESTION_ID", "5045"))
HISTORICAL_VENDOR_DATA_QUESTION_ID = int(os.getenv("HISTORICAL_VENDOR_DATA_QUESTION_ID", "6206"))
...
VENDOR_REFRESH_INTERVAL_MINUTES = int(os.getenv("VENDOR_REFRESH_INTERVAL_MINUTES", "60"))
...
- PAGE_SIZE: Metabase page size (default: 50000000)
